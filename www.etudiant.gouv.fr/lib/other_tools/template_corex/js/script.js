...
(function ($) { "use strict";
    ...
    var duration = 500;
    /**
     * Mis en commentaire car création d'un objet dans notre js pour gérer les différents sites.
     */
    ...
    jQuery('#totop').keypress(function (event) {
        event.preventDefault();
    ...
    var configdrop = {
		...
		/**
		 * Mis en commentaire pour récupérer le fonctionnement par défaut de Bootstrap
		 */
